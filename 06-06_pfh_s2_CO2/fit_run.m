...
% run name for plots
pname = 'CO2, 25 May 2021 PFL side 1';
...
% gas file and weight
opt.abswt = 12.69;
opt.afile = 'lblr_CO2_49p54_Torr_16p80_C';
...
igm.ET2 = igm.ET2(:, :, 20:345);
igm.ET1 = igm.ET1(:, :, 794:1109);
igm.FT2 = igm.FT2(:, :, 25:342);
igm.FT1 = igm.FT1(:, :, 25:340);
