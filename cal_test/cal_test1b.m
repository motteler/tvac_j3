%
% cal_test1 -- basic calibrated radiances, ccast eqn (2)
%
...
[nchan,~,~] = size(Sinv);
Sfwd = zeros(nchan, nchan, 9);
for j = 1 : 9
  Sfwd(:, :, j) = inv(squeeze(Sinv(:, :, j)));
end
